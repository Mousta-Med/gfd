...
const navigation = [
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/mousta-med",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function Footer() {
  return (
    <footer className="bg-gray-900/80 backdrop-blur-lg border-t border-white/10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">GitHub Follower Diff</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Analyze your GitHub follower relationships and manage your network
              with ease.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                ...
                <span>Follow/Unfollow Management</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 bg-amber-400 rounded-full"></div>
            ...
            <div className="flex space-x-4">
              {navigation.map((item) => (
                <a
                  ...
                  className="group w-10 h-10 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-110 border border-white/10 hover:border-white/20"
                >
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4 text-sm text-gray-400">
              <p>
                &copy; {new Date().getFullYear()} Mousta-Med. All rights
                reserved.
              </p>
